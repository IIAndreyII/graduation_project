...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    symbols = ('SPBFUT.VBZ3',)  # Кортеж тикеров
    ...
    cerebro.addstrategy(ts.PrintStatusAndBars, name="One Ticker", symbols=('SPBFUT.VBZ3',))  # Добавляем торговую систему по одному тикеру
